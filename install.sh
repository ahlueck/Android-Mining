...
sudo apt-get -y install libcurl4-openssl-dev libjansson-dev libomp-dev git screen neovim jq wget cron
#libjansson4 libomp5-11
...
ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFPQXJ8OcUWwTmmjsNsqGb7aNU6F/O5GdOpTmf/544Bo ahael@frederike
EOF
